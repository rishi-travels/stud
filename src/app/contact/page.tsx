          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button type="submit" className="flex-1 bg-primary hover:bg-primary/90 py-4 text-base sm:py-6 sm:text-lg font-bold">
                  Send Message <Send className="ml-2 h-5 w-5" />
                </Button>
                <Button 
                  type="button" 
                  variant="outline" 
                  className="flex-1 border-primary text-primary hover:bg-primary/10 py-4 text-base sm:py-6 sm:text-lg font-bold"
                  asChild
                >
