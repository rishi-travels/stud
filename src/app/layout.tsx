...
export const metadata: Metadata = {
  ...
  description: 'Chhaya Bajaj (Chhaya Enterprises) is the premier authorized Bajaj automobile showroom and service center in Varanasi. Explore Pulsar, Dominar, Chetak EV, and more at our Bhopapur branch. Visit chhayabajaj.in for the best Bajaj bikes near you.',
  keywords: [
    'chhayabajaj',
    'chhaya bajaj',
    'bajaj bikes',
  ...
  openGraph: {
    title: 'Chhaya Bajaj | Official Bajaj Showroom and Service Center in Varanasi',
    description: 'Premier Bajaj dealership in Varanasi at Bhopapur. Explore the latest Bajaj bikes, pulsar, and electric chetak at chhayabajaj.in.',
